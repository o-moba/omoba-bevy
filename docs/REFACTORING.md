...
| 7 | Server `MatchRules` policy object; career, transport and clock behind traits | done | #31, this PR |
...
Suggested order after 7: 14, 10, 15, 11, 12, 13, 9b (server first while
...
### 7: MatchRules, career trait, Transport/Clock (done, #31 + this PR)
