...
| 10 | Client domain module, combat/player split, render backends behind `run_if`, plugin groups, QA behind a cargo feature | in progress: 10a+10d (this PR); slices in [plans/client-10-15.md](plans/client-10-15.md) | this PR |
