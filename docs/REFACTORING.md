...
Still open from §8.2: O2 (CI as a required gate: branch protection, auto-merge, rules 2 and 6) and the rest of the list outside the rows above.
...
### 11: One debug tooling family (in progress: 11-0 #34, 11a-11c #42, 11d #43)
