    ...
    for (name, mut text) in &mut copy {
        match name.as_str() {
            ...
            "MatchStatusText" => text.0 = text.0
                ...
                .replace("Click a foe to attack  /  P shop  /  F1 help", "Hold ATTACK · Drag skills to aim")
                .replace("Target selected: Q attacks", "Target selected: hold ATTACK"),
