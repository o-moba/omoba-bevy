...
- **An engine people can build on.** Keep the licensed engine and server source available. Support learning, modification and independent games and servers. Preserve reciprocity through standard open-source licenses.

- **Identity with permission.** Work toward supported, portable avatars while respecting creators, likeness rights, consent and the licenses on each model. Wallet integration is one mechanism; it does not replace those rights.
...
- **A sustainable official service.** Fund development and reliable operations through offerings compatible with fair play. An independent fork may choose its own direction under the applicable licenses.

These are the goals of the official project. They are not additional legal restrictions on what people may do with licensed source. A fork does not need our approval, endorsement or agreement with every product decision.

The project began with Wotori's intention to give people's avatars a playable home. Contributions should help that idea become useful beyond its founder, while each creator keeps the rights they have in their work.
